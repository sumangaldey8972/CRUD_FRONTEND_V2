...
import { edit_user_action, get_user_by_id_action } from '../store/Users/user.action'
                    ...
                    <FormControl >
                        <Grid templateColumns='repeat(2, 1fr)' gap={6}>
                            <GridItem>
                                ...
                                <Input type='text' name="user_name" value={creds.user_name} onChange={handleInputChange} />
                            </GridItem>
                            <GridItem>
                            ...
                            <GridItem>
                                ...
                                <Input type='Date' name="user_dob" value={formatDate(creds.user_dob)} onChange={handleInputChange} />
                            </GridItem>
                            <GridItem>
                            ...
                            <GridItem w='200%'>
                                <Flex alignItems='center' gap="7px" w='40%' m='auto' justifyContent='space-between' verticalAlign='middle' >
                                    <Box  ><Image src={showImage} /></Box>
                                    <Box bgColor='orange' cursor='pointer' borderRadius='5px' p="1" color='white' onClick={()=>setShow(!show)} > <Text> {show ? "Cancel" : "Change"} </Text> </Box>
                                </Flex>
                                {
                                    show && <><FormLabel>Select Image</FormLabel>
                                        <Input type='file' accept='image/*' name="image" onChange={handleImageChange} /> </>
                                }

                            </GridItem>
                        </Grid>
                        <Button mt="4" type="submit" onClick={handleSubmit} colorScheme='teal' > {loading ? <Spinner /> : 'Edit User'} </Button>
                    </FormControl>
                </Container>
            </VStack>
        </>
