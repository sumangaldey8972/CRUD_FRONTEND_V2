...
const Login = () => {
    ...
    return (
        <VStack>
            ...
            <Container maxW='sm' textAlign="center" p="6" border="1px solid teal" borderRadius=".9rem" m="4rem auto" >
                <FormControl >
                    ...
                    <Button mt="4" type="submit" onClick={handleSubmit} colorScheme='teal' > {loading ? <Spinner/> : 'Login'} </Button>
                </FormControl>
            </Container>
        </VStack>
    )
